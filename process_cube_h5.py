...
delays = bin_cspad_sum.bin_edges() # return edges, first bin is outside range left and last bin is outside range right. everything in (a,b] is averaged in bin b.
